 ...
 * errors and also (b) makeRequest is not a function, which is baffling.
 * 
 * @see https://github.com/aws/aws-sdk-js/issues/1939
 * 
 * CORS isn't available for listBuckets so we'll always have trouble
 */
